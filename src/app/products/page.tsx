  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Discover everything your pet needs, carefully selected for quality and nutrition.</p>
      </div>
        ...
        <div className="w-full lg:w-64 flex-shrink-0">
          <div className="bg-white/60 p-6 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 sticky top-24">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-sm font-medium text-gray-900 mb-3">Pet Type</h3>
